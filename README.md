...
POST&nbsp;/v1/notifications | `notifications.send(notification)` | Send a notification to a contact. The notifications docs are to be found [here](https://docs.amio.io/v1.0/reference#notifications-send-notification) only.
